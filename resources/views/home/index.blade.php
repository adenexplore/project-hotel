...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    {{-- <form
        ...
        <div class="input-group">
            <input type="text" id="kamar" class="form-control bg-light border-0 small" placeholder="Search for..."
                    ...
                    <form action="#" POST>
                        <div class="col mr-2">
                            <div class="text font-weight-bold text-danger text-uppercase mb-1" class="kamar" style="text-align:center;">
                                {{ number_format($cekin) }} person </div>
                    ...
                    <form action="#" POST>
                        <div class="col mr-2">
                            <div class="text-xxl font-weight-bold text-success text-uppercase mb-1" class="kamar" style="text-align:center;">
                                {{ number_format($booking) }} person </div>
